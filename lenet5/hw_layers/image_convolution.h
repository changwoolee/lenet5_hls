...
//#pragma SDS data mem_attribute(input_feature:PHYSICAL_CONTIGUOUS,conv_kernel:PHYSICAL_CONTIGUOUS,conv_bias:PHYSICAL_CONTIGUOUS,output_feature:PHYSICAL_CONTIGUOUS)
#pragma SDS data access_pattern(input_feature:SEQUENTIAL,conv_kernel1:RANDOM,conv_kernel2:RANDOM,conv_kernel3:RANDOM,conv_bias:SEQUENTIAL,output_feature:SEQUENTIAL)
